...
import 'ajuda_bloc.dart';


class AjudaProvider extends InheritedWidget {
  final bloc = AjudaBloc();

  AjudaProvider({Key key, Widget child}) : super(key: key, child: child);

  bool updateShouldNotify(_) => true;

  static AjudaBloc of(BuildContext context) {
    ...
    return (context.inheritFromWidgetOfExactType(AjudaProvider) as AjudaProvider).bloc;
  }
}